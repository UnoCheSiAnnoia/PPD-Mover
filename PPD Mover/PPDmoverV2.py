...
selectDirOutline = canv.create_text(79, 28, text="Select Directory", font=Underlined, fill="#4b5676")
selectDirText = canv.create_text(80, 29, text="Select Directory", font=Underlined, fill="White")
selZipOutline = canv.create_text(79, 128, text="Select .zip file", font=Underlined, fill="#4b5676")
selZipText = canv.create_text(80, 129, text="Select .zip file", font=Underlined, fill="White")
selMp4Outline = canv.create_text(79, 228, text="Select the mp4", font=Underlined, fill="#4b5676")
selMp4Text = canv.create_text(80, 229, text="Select the mp4", font=Underlined, fill="White")
foldTextOutline = canv.create_text(242, 228, text="Select the song folder", font=Underlined, fill="#4b5676")
selFoldText = canv.create_text(243, 229, text="Select the song folder", font=Underlined, fill="White")
removeZipOutline = canv.create_text(74, 381, text="Delete .zip", fill="#4b5676")
removeZipText = canv.create_text(75, 382, text="Delete .zip", fill="White")
